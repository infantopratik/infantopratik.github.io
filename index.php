...
<html>
	...
	<body onload="myFunc()">
		<div id="preloader">
			<img src="images/loader_background.jpg"></img>
			<svg>
				<circle cx="100" cy="100" r="95" stroke="#d71f4f" stroke-width="10" />
			</svg>
			<div id="status">&nbsp;</div>
			<div id="preload-back">
				<h1>WELCOME TO <strong>ONE GAME</strong></h1>
			</div>
		</div>
		...
		<div class="wrapper">
			...
			<div class="container-fluid wrapper2" id="intro-hero">
				<div class="row">
					...
					<div class="col-md-4">
						<div id="container">
							<img src="images/pendulum.png" width="160" height="200"></img>
							<div class="oscillate wrapper2">       
							</div>
						</div>
						<div id="date"></div>
						<div id="days"></div>	
